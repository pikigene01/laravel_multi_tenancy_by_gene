                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control " type="text" name="contact_no"
                                                    placeholder="{{('+40-745-234-567')}}" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            @endif
                                            <div>
                                                <button type="reset" class="btn btn-secondary d-none"></button>
                                                <button type="submit" class="btn btn-primary btn-block mt-2" tabindex="4">{{__('Send your message')}}</button>
                                            </div>
                                            </form>
                                        </div>
                                    </div>
