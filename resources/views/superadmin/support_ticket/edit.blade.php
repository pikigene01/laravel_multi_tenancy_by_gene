                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <small>
                            <span class="text-right">
                                {{ __('Status') }} : <span
                                    class="badge rounded-pill @if ($supportticket->status == 'In Progress') badge bg-warning  @elseif($supportticket->status == 'On Hold') badge bg-danger @else badge bg-success @endif">{{ __($supportticket->status) }}</span>
                            </span>
                        </small>
                    </div>
                </div>
