            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div id="useradd-2" class="card">
                        ...
                        {{ Form::open(['route' => ['profile.update', $user->id], 'method' => 'Post', 'class' => 'form-horizontal', 'data-validate']) }}
                        <div class="card-body">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div id="avatar-updater" class="col-xs-12 d-none">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                {!! Form::text('avatar-url', route('update-avatar', Auth::user()->id), [
                                                    'class' => 'd-none',
                                                ]) !!}
                    ...
                    <div id="useradd-3" class="card">
                        ...
                        {{ Form::open(['route' => ['update_login', $user->id], 'method' => 'Post', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-validate']) }}
                        <div class="card-body">
                            <div class="row form-group">
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="card-body">
                                    <div class="row p-0">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            {{ Form::submit(__('Activate 2fa'), ['class' => 'btn btn-primary  col-md-2 float-end']) }}
                                            {!! Form::close() !!}
                                        </div>
