...
@else
    <a class="btn btn-sm small btn btn-danger " href="{{ route('user.status', $user->id) }}"
        ...
        data-bs-original-title="{{ __('Deactive') }}" aria-label="{{ __('Deactive') }}"><i
            class="ti ti-ban text-white"></i></a>
@endif
@can('impersonate-user')
    <a class="btn btn-sm small btn btn-info " href="{{ route('impersonate', $user->id) }}"
...
@if ($user->email_verified_at)
    <a class="btn btn-sm small btn btn-danger " href="{{ route('user.verified', $user->id) }}"
        data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
        data-bs-original-title="{{ __('Unverified') }}" aria-label="{{ __('Unverified') }}"><i
            class="ti ti-user-exclamation text-white"></i></a>
@else
    <a class="btn btn-sm small btn btn-success " href="{{ route('user.verified', $user->id) }}"
        data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
        data-bs-original-title="{{ __('Verified') }}" aria-label="{{ __('Verified') }}"><i
            class="ti ti-user-check text-white"></i></a>
@endif
@can('edit-user')
