...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Froentend Settings') }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#post_setting" class="list-group-item list-group-item-action ">{{ __('Post Setting') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div id="captcha_setting"
                                        class="{{ Utility::getsettings('captcha_status') == 1 || Utility::getsettings('captcha_status') == '' ? 'd--flex' : 'd-none' }} row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
