<template>
    ...
    <nav class="navbar navbar-expand-md navbar-dark default top-nav-collapse">
        <div class="container">
            <a class="navbar-brand bg-transparent" href="/landingpage">
                <img
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                >
                    ...
                    <li class="nav-item" v-else>
                        <Link class="nav-link" href="/home">Login</Link>
                    </li>

                    <li class="nav-item" v-if="this.app_values['tenant_id']">
                        <Link class="nav-link" href="/#plans">Plans</Link>
                    </li>
                    <li class="nav-item" v-else>
                        <Link class="nav-link" href="/view/post">Blogs</Link>
                    </li>
                </ul>
            </div>
        </div>
