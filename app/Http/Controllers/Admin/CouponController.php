...
class CouponController extends Controller
{
    public function index(CouponDataTable $dataTable)
    {
        if (\Auth::user()->can('manage-coupon')) {
            ...
            return $dataTable->render('admin.coupon.index', compact('total_coupon', 'expiered_coupon', 'total_used_coupon', 'total_use_amount'));
        } else {
    ...
    {
        return view('admin.coupon.upload_coupon');
    }
    ...
    public function masscreate()
    {
        if (\Auth::user()->can('mass-create-coupon')) {
            return view('admin.coupon.mass_create');
        } else {
            return redirect()->back()->with('failed', __('Permission denied.'));
        }
    }
