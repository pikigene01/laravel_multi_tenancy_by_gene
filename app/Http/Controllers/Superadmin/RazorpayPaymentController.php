...
class RazorpayPaymentController extends Controller
{
    public function razorPaypayment(Request $request)
    {
        ...
        $coupouns =  tenancy()->central(function ($tenant) use ($plan, $request) {
    ...
    public function razorPaycallback(Request $request, $order_id, $transaction_id, $requestdomain_id, $coupon_id)
    {
