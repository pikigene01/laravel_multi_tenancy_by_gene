...
class PaystackController extends Controller
{
    public function paystackpayment(Request $request)
    {
        ...
        $res_data['currency']    = UtilityFacades::getsettings('paystack_currency');
        $res_data['coupon']      = $coupon_id;
        $res_data['plan_id'] = $plan->id;
        return $res_data;
    }

    public function paystackcallback(Request $request, $order_id, $transaction_id, $requestdomain_id, $coupon_id)
    {
